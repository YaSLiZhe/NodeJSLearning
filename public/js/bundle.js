...
var stripe = Stripe('pk_test_51NJ4ZGAZBUwv1K4VxshvCd0BikLomKDhuLX1ZF3gRp0LfhV3RTdaihRg5KJ8lcSWfJ6QrbOG0wNWwhk41pGWn6qa00W5tlZRQa');
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/bookings/checkout-sessions/".concat(tourId),
            data: session
          });
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error logging out, try agagin!');
        case 11:
        case "end":
...
var displayMap = function displayMap(locations) {
  ...
  var markerStyle = new ol.style.Style({
    image: new ol.style.Icon({
      src: '../img/pin.png',
      // Replace with your marker icon image path
      scale: 0.1 // Adjust the scale as needed
    })
  });

  locations.forEach(function (location) {
    var _location$coordinates = _slicedToArray(location.coordinates, 2),
  ...
  function createPopupElement(description, day) {
    ...
    popupElement.innerHTML = "\n    <div class=\"popup-header\">\n      <h4>".concat(description, "</h4>\n      <span class=\"popup-close\">x</span>\n    </div>\n    <div class=\"popup-body\">\n      <p>Day ").concat(day, "</p>\n    </div>\n  ");

    // Close function for the popup
    var closeButton = popupElement.querySelector('.popup-close');
